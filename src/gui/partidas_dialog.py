...
class SuggestedPartidasDialog(QDialog):
    ...
    def _build_ui(self):
        ...
        self._table.horizontalHeaderItem(0).setToolTip("Doble clic en una fila para marcar/desmarcar")
        ...
        btn_cancel = QPushButton("Omitir partidas", panel)
        btn_cancel.setFont(theme.font_base())
        btn_cancel.setFixedSize(140, 44)
